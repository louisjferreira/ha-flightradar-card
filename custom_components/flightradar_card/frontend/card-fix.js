    ...
    if (originalDrawMap) {
      Card.prototype._drawMap = function () {
        ...
        if (!style) {
          ...
          style.textContent = `.aircraft-icon{width:42px!important;height:42px!important;display:block!important;position:absolute!important;pointer-events:auto!important;transform-origin:50% 50%!important;filter:drop-shadow(0 2px 3px rgba(0,0,0,.75))}.aircraft-icon img{width:100%!important;height:100%!important;display:block!important;object-fit:contain!important;overflow:visible!important}.aircraft-icon.is-selected img{filter:hue-rotate(205deg) saturate(1.35) brightness(1.15) drop-shadow(0 0 3px rgba(255,210,45,.95))}.traffic{width:max-content!important;min-width:0!important;max-width:calc(100% - 24px)!important;box-sizing:border-box}.traffic-row{grid-template-columns:max-content max-content max-content max-content max-content!important;white-space:nowrap!important;cursor:pointer!important}.traffic-row:hover{background:#2b333a!important}.card.windy-mode .map{z-index:4;background:transparent!important;pointer-events:none!important}.card.windy-mode .tiles{display:none!important}.card.windy-mode .overlay{display:block!important;pointer-events:none!important}.card.windy-mode .aircraft-icon{pointer-events:auto!important}.card.windy-mode .trail-svg{display:block!important;pointer-events:none!important}.card.windy-mode .windy{z-index:3!important}`;
